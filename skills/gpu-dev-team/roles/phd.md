...
2. Research the topic using available tools (web search, file reading, documentation).
3. Provide a thorough answer to the professor with evidence, sources, and your assessment of confidence.
4. If you are uncertain, say so explicitly. Do not speculate without labeling it as speculation.
