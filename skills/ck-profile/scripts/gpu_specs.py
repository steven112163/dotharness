...
PEAK_MEM_GBS = {
    "gfx942": 5300.0, "gfx950": 8000.0, "gfx1250": 19600.0, "gfx1251": 19600.0,
    "gfx1201": 640.0, "gfx1200": 320.0, "gfx1100": 960.0, "gfx1101": 624.0, "gfx1102": 288.0,
}
...
SPECS = {
    ...
    "gfx942": {"product": "MI300X/MI325X", "cu": 304, "wave": 64, "simd_per_cu": 4,
               "max_waves_cu": 32, "vgpr_per_simd": 256, "agpr_per_simd": 256, "lds_kb_per_cu": 64},
    # CDNA4 — 256 CU, 160 KB LDS/CU; VGPR/AGPR unification unverified, keep CDNA3 model.
    "gfx950": {"product": "MI350X/MI355X", "cu": 256, "wave": 64, "simd_per_cu": 4,
               "max_waves_cu": 32, "vgpr_per_simd": 256, "agpr_per_simd": 256, "lds_kb_per_cu": 160},
    # CDNA-next (MI4xx) — unreleased; only HBM4 bandwidth is public.
    "gfx1250": {"product": "MI450/MI455X", "cu": None, "wave": 64, "simd_per_cu": None,
                "max_waves_cu": None, "vgpr_per_simd": None, "agpr_per_simd": None, "lds_kb_per_cu": None},
    "gfx1251": {"product": "MI430X", "cu": None, "wave": 64, "simd_per_cu": None,
                "max_waves_cu": None, "vgpr_per_simd": None, "agpr_per_simd": None, "lds_kb_per_cu": None},
    # RDNA4 — wave32, 2 SIMD/CU, 1536 VGPR/SIMD, 128 KB LDS/CU. Flagship CU counts.
    "gfx1201": {"product": "RX 9070 XT", "cu": 64, "wave": 32, "simd_per_cu": 2,
                "max_waves_cu": 32, "vgpr_per_simd": 1536, "agpr_per_simd": 0, "lds_kb_per_cu": 128},
    "gfx1200": {"product": "RX 9060 XT", "cu": 32, "wave": 32, "simd_per_cu": 2,
                "max_waves_cu": 32, "vgpr_per_simd": 1536, "agpr_per_simd": 0, "lds_kb_per_cu": 128},
    # RDNA3 — wave32, 2 SIMD/CU, 128 KB LDS/CU. Navi33 (gfx1102) has a smaller VGPR file.
    "gfx1100": {"product": "RX 7900 XTX", "cu": 96, "wave": 32, "simd_per_cu": 2,
                "max_waves_cu": 32, "vgpr_per_simd": 1536, "agpr_per_simd": 0, "lds_kb_per_cu": 128},
    "gfx1101": {"product": "RX 7800 XT", "cu": 60, "wave": 32, "simd_per_cu": 2,
                "max_waves_cu": 32, "vgpr_per_simd": 1536, "agpr_per_simd": 0, "lds_kb_per_cu": 128},
    "gfx1102": {"product": "RX 7600", "cu": 32, "wave": 32, "simd_per_cu": 2,
                "max_waves_cu": 32, "vgpr_per_simd": 1024, "agpr_per_simd": 0, "lds_kb_per_cu": 128},
}
