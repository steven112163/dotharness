...
- Use active voice when the actor matters: "the function returns X" not "X is returned."
- Be concrete and specific. Avoid vague abstractions like "various factors" or "certain aspects."
- Cut filler words. Replace "in order to" with "to", "due to the fact that" with "because."
- Avoid clichés and dead metaphors: "paves the way", "leverages", "paradigm shift."
- Skip jargon the audience has not been introduced to.

## Precision

- Prefer affirmative phrasing: "the request failed" not "the request did not succeed."
- Match claim strength to evidence. No "significantly" or "dramatically" without data.
...
Rules serve clarity. When a rule fights the sentence, drop the rule.
