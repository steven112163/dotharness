...
- `multi-review` — 8 parallel reviewers (4 Claude subagents by lens + 4 background `bin/llm` calls); consolidator subagent; validation subagent; dedup against existing PR reviews.
